...
public class Feed extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View guillotineMenu = LayoutInflater.from(this).inflate(R.layout.guillotine_feed, null);
            ...
            public void onClick(View v) {
                switch(v.getId()){
                    case R.id.feed_group:
                        Intent b = new Intent(Feed.this,Feed.class);
                        startActivity(b);
                        break;
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    case R.id.activity_group:
                        Intent b = new Intent(Feed.this, MainActivity.class);
                        startActivity(b);
                        break;
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    case R.id.settings_group:
                        Intent b = new Intent(Feed.this, Settings.class);
                        startActivity(b);
                        break;
